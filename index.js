...
Car.prototype.accelerate = function (addSpeed) {
  this.speed += addSpeed;
  console.log(
...
Car.prototype.brake = function (reduceSpeed) {
...
Car.prototype.drive = function (journey) {
  let kilometers = 0;
  kilometers += journey;
  console.log(
...
const driveFunction = newCar.drive.bind(newCar);
newCar.drive(100);
